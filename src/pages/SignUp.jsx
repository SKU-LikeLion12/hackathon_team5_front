...
export default function SignUp() {
    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen bg-[#E2E9F2'>
            <form className='w-[45%] p-[3%] shadow-2xl rounded-2xl mx-auto bg-[#E2E9F2]' style={{ boxShadow: '0px 4px 12px rgba(120, 157, 195, 0.8)' }}>
